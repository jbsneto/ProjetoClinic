 ...
 * @author GENPAC
 */
public class JfEntregue extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jbEntregue = new javax.swing.JButton();
        ...
        jbEntregue.setText("Entregue");
        jbEntregue.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jbEntregueActionPerformed(evt);
            }
        });
    ...
    private void jbExtraviadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbExtraviadoActionPerformed
        try{
            ...
            if(result == JOptionPane.YES_OPTION){
                ...
                if(!exameCliente.getStatus().equals(Util.getStatusExtraviado()) && !exameCliente.getStatus().equals(Util.getStatusExaminado()) && !exameCliente.getStatus().equals(Util.getStatusEntregue())){
                    ...
                    JOptionPane.showMessageDialog(null, "Escolha um exame que ainda não foi examinado ou extraviado");
                }
            }else
    ...
    private void jbEntregueActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbEntregueActionPerformed
        try{
            ...
            if(result == JOptionPane.YES_OPTION){
                ...
                if(exameCliente.getStatus().equals(Util.getStatusColetado())  && !exameCliente.getStatus().equals(Util.getStatusExaminado())){
                    log = new LogExame(funcionario, exameCliente, exameCliente.getStatus(),Util.getStatusEntregue() );
                    facade.cadastraLog(log);

                    exameCliente.setStatusEntregue();
                    facade.exameClienteEditar(exameCliente);
                    JOptionPane.showMessageDialog(null, "Status alterado com sucesso");
                }else{
    ...
    }//GEN-LAST:event_jbEntregueActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JfEntregue.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JfEntregue().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton jbEntregue;
