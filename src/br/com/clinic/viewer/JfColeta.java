 ...
 * @author GENPAC
 */
public class JfColeta extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jbColetado = new javax.swing.JButton();
        ...
        jbColetado.setText("Coletado");
        jbColetado.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jbColetadoActionPerformed(evt);
            }
        });
    ...
    private void jbColetadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbColetadoActionPerformed
        try{
            
            int result = JOptionPane.showConfirmDialog(null,"Deseja mudar o status do Exame para Coletado?", "Confirmar", JOptionPane.YES_NO_OPTION);
            if(result == JOptionPane.YES_OPTION){
                int index = this.jTable.getSelectedRow();
                String idString = this.jTable.getValueAt(index, 0).toString();
                long idExame = Long.parseLong(idString);
                exameCliente = facade.exameClienteBuscar(idExame);
                if((exameCliente.getStatus().equals(Util.getStatusPendente()) || exameCliente.getStatus().equals(Util.getStatusExtraviado())) && !exameCliente.getStatus().equals(Util.getStatusColetado())){
                    log = new LogExame(funcionario, exameCliente, exameCliente.getStatus(),Util.getStatusColetado() );
                    facade.cadastraLog(log);

                    exameCliente.setStatusColetado();
                    facade.exameClienteEditar(exameCliente);
                    JOptionPane.showMessageDialog(null, "Status alterado com sucesso");
                }else{
                    JOptionPane.showMessageDialog(null, "O exame já foi coletado");
                }
            }else
                JOptionPane.showMessageDialog(null, "Status não alterado");
        }catch (Exception e){
    ...
    }//GEN-LAST:event_jbColetadoActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JfColeta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JButton jbColetado;
    ...
    private void preencherListaColetado() throws Exception{
        ...
        if(aux){
           limparTabela();
           JOptionPane.showMessageDialog(null,"Nenhum exame Coletado"); 
        } 
        }else
           JOptionPane.showMessageDialog(null,"Sem exames para listar"); 
    }
