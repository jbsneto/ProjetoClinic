...
public class JdPesquisaFuncionario extends javax.swing.JDialog {
    ...
    private void jTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableMouseClicked
        try{
            ...
            if(result == JOptionPane.YES_OPTION){
                ...
                long idFunc = Long.parseLong(idString);
                this.func = facade.funcionarioBuscar(idFunc);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JdPesquisaFuncionario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JdPesquisaFuncionario dialog = new JdPesquisaFuncionario(new javax.swing.JFrame(), true);
    ...
    private void preencherListaId() throws Exception{
        ...
        if(!"".equals(this.jtPesquisa.getText())){
            ...
            Funcionario f = facade.funcionarioBuscar(id);    
            if(f!=null){
                for (Funcionario fun : facade.funcionarioListar()){	
                    if(fun.getId() == id){
                        dm.addRow(new Object[] {fun.getId(), fun.getNome(),fun.getCpf(),fun.getCargo()});
                    }
    ...
    private void preencherListaNome() throws Exception{
        DefaultTableModel dm = (DefaultTableModel) jTable.getModel();
        dm.getDataVector().removeAllElements();
        if(facade.funcionarioListar()!= null){
            for (Funcionario fun : facade.funcionarioListar()){	
                dm.addRow(new Object[] {fun.getId(), fun.getNome(),fun.getCpf(),fun.getCargo()});
            }
        }else
    ...
    public Funcionario getFuncionario(){
        System.out.println(func.getLogin() + " " + func.getSenha());
        return this.func;
